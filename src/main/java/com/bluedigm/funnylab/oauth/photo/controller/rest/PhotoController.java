...
import com.bluedigm.funnylab.oauth.photo.controller.rest.PhotoInfo;
import com.bluedigm.funnylab.oauth.photo.controller.rest.PhotoService;
...
public class PhotoController {
	...
	public ResponseEntity<byte[]> getPhoto(HttpServletRequest request, @PathVariable("photoId") String id) throws IOException {
		Enumeration< String> aa = request.getHeaderNames();
		while(aa.hasMoreElements()){
			String name = (String)aa.nextElement();
			System.out.println("cccccccccccccccc key : " + name);
			System.out.println("cccccccccccccc  value : " + request.getHeader(name));
		}
